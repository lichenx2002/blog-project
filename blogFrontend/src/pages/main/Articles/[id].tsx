...
const ArticleDetail: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <div onClick={() => routerBack.back()} className={styles.backLinkButton}>
                ...
                >
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            // 段落样式
                            p: ({ node, ...props }) => <p className={styles.paragraph}
                                                          style={{ fontFamily: "'zihun', sans-serif" }}
                                                          {...props} />,
                            ...
                            li: ({ node, ...props }) => <li className={styles.listItem} style={{ fontFamily: "'zihun', sans-serif" }} {...props} />,

                            // 引用样式
                            blockquote: ({ node, ...props }) => <blockquote className={styles.blockquote} style={{ fontFamily: "'zihun', sans-serif" }} {...props} />,
